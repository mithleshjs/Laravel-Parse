...
Laravel Parse was created by, and is maintained by [Graham Campbell](https://github.com/GrahamCampbell), and is a [Parse SDK](https://github.com/ParsePlatform/parse-php-sdk) bridge for [Laravel 5](http://laravel.com) with support for self-hosted [Parse Server](https://github.com/ParsePlatform/parse-server). Feel free to check out the [change log](CHANGELOG.md), [releases](https://github.com/mithleshjs/Laravel-Parse/releases), [license](LICENSE), and [contribution guidelines](CONTRIBUTING.md).
